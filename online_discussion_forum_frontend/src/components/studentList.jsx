                            ...
                            >
                                <Box display="flex" flexDirection="row" gap={3}>
                                    <Avatar sx={{ width: 100, height: 100, bgcolor: 'primary.main' }}>
                                        {user.profile ? (
                                            <img src={`http://localhost:3000/${user.profile}`} alt="userProfile" style={{ borderRadius: '50%' }} />
                                        ) : <img src={`https://picsum.photos/id/237/200/300`} alt="userProfile" style={{ borderRadius: '50%' }} />}
                                    </Avatar>
